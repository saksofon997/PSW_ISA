(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
                    ...
                    providers: [ngx_cookie_service__WEBPACK_IMPORTED_MODULE_5__["CookieService"], _services_user_service__WEBPACK_IMPORTED_MODULE_58__["UserService"],
                        {
                            ...
                            useFactory: function (userService) { return function () { }; },
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var AdminCDashboardComponent = /** @class */ (function () {
                ...
                AdminCDashboardComponent.prototype.ngOnInit = function () {
                };
                AdminCDashboardComponent.prototype.showClinicInfo = function () {
                    var _this = this;
                    ...
                    this.clinicAdminService.getClinic(clinicID).subscribe(function (data) {
                        _this.router.navigate(['clinic'], { relativeTo: _this.activatedRoute, state: { data: data } });
                    }, function (error) {
                        alert(error);
                    });
                };
            ...
            AdminCDashboardComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var AdminCPersonalProfileComponent = /** @class */ (function () {
                ...
                AdminCPersonalProfileComponent.prototype.ngOnInit = function () {
                    this.getAdminInfo();
                };
                AdminCPersonalProfileComponent.prototype.getAdminInfo = function () {
                    var _this = this;
                    this.clinicAdminService.getAdminC().subscribe(function (data) {
                        _this.admin = data;
                        _this.form = _this.formBuilder.group({
                            name: [_this.admin.name, [_angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].required,]],
                            surname: [_this.admin.surname, [_angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].required]],
                            email: [_this.admin.email, [_angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].required, _angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].email]],
                            address: [_this.admin.address, [_angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].required]],
                            city: [_this.admin.city, [_angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].required]],
                            state: [_this.admin.state, [_angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].required]],
                            phoneNumber: [_this.admin.phoneNumber, [_angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].required]],
                            upin: [_this.admin.upin, [_angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].required, _angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].minLength(13), _angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].maxLength(13)]]
                        });
                        _this.change = true;
                    }, function (error) {
                        alert(error);
                ...
                AdminCPersonalProfileComponent.prototype.enableChangeInfo = function () {
                    this.change = !this.change;
                };
                AdminCPersonalProfileComponent.prototype.cancelChanges = function () {
                    this.change = !this.change;
                    this.getAdminInfo();
                };
                AdminCPersonalProfileComponent.prototype.showChangePasswordForm = function () {
                    this.router.navigate(['../change-password']);
                };
                AdminCPersonalProfileComponent.prototype.onSubmit = function () {
                    var _this = this;
                    this.submitted = true;
                    ...
                    this.clinicAdminService.changeAdminC(adminC).subscribe(function (data) { _this.change = !_this.change; return; }, function (error) { alert(error); });
                };
                return AdminCPersonalProfileComponent;
            }());
            AdminCPersonalProfileComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var AvailableAppointmentListingComponent = /** @class */ (function () {
                function AvailableAppointmentListingComponent(clinicService, router, activatedRoute, userService, appointmentService, confirmationDialogService) {
                    var _this = this;
                    ...
                    this.navigationSubscription = this.router.events.subscribe(function (e) {
                        if (e instanceof _angular_router__WEBPACK_IMPORTED_MODULE_2__["NavigationEnd"]) {
                            _this.clinicID = _this.userService.getUser().clinic_id;
                            _this.getAppointments();
                        }
                    });
                }
                AvailableAppointmentListingComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    this.activatedRoute.params.subscribe(function (params) {
                        _this.clinicID = params.id;
                        _this.clinicName = params.name;
                    });
                };
                AvailableAppointmentListingComponent.prototype.getAppointments = function () {
                    var _this = this;
                    ...
                    this.appointmentService.getClinicAvailableAppointments(this.clinicID).subscribe(function (data) {
                        ...
                        for (var _i = 0, _a = _this.appointments.entries(); _i < _a.length; _i++) {
                            var _b = _a[_i], i = _b[0], value = _b[1];
                            _this.appointments[i].formatedDateAndTime = _this.timeConverter(_this.appointments[i].startingDateAndTime);
                        }
                        _this.appointments.sort(function (a, b) { return (a.id > b.id) ? 1 : -1; });
                    }, function (error) {
                        alert(error);
                    });
                };
                AvailableAppointmentListingComponent.prototype.addNewAppointment = function () {
                    this.router.navigate(['../new_available_appointment'], { relativeTo: this.activatedRoute });
                };
                AvailableAppointmentListingComponent.prototype.deleteAppointment = function (appointment) {
                    var _this = this;
                    this.confirmationDialogService.confirm('Please confirm', 'Are you sure you want to delete available appointment: ' + appointment.doctors[0].name + ' ' + appointment.doctors[0].surname + ' ' + appointment.ordination.name + '?', false)
                        ...
                        if (confirmed.submited) {
                            _this.appointmentService.deleteAvailableAppointment(appointment.id).subscribe(function (data) {
                                _this.getAppointments();
                            }, function (error) {
                                alert(error);
                            });
                ...
                AvailableAppointmentListingComponent.prototype.timeConverter = function (UNIX_timestamp) {
                ...
                AvailableAppointmentListingComponent.prototype.ngOnDestroy = function () {
            ...
            AvailableAppointmentListingComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ClinicProfileInfoComponent = /** @class */ (function () {
                function ClinicProfileInfoComponent(clinicService, router, activatedRoute, formBuilder) {
                    this.clinicService = clinicService;
                    this.router = router;
                    this.activatedRoute = activatedRoute;
                    this.formBuilder = formBuilder;
                }
                ClinicProfileInfoComponent.prototype.ngOnInit = function () {
                    this.clinic = history.state.data;
                    this.clinicBackup = history.state.data;
                    this.createFormGroup();
                };
                ClinicProfileInfoComponent.prototype.createFormGroup = function () {
                    var name = "";
                    var address = "";
                    var city = "";
                    var state = "";
                ...
                ClinicProfileInfoComponent.prototype.enableChangeInfo = function () {
                    this.formDisabled = !this.formDisabled;
                };
                ClinicProfileInfoComponent.prototype.cancelChanges = function () {
                    this.formDisabled = !this.formDisabled;
                    this.clinic = this.clinicBackup;
                    this.createFormGroup();
                };
                ClinicProfileInfoComponent.prototype.onSubmit = function () {
                    var _this = this;
                    this.submitted = true;
                    ...
                    if (this.clinicID) {
                        ...
                        this.clinicService.changeClinicInfo(clinic).subscribe(function (data) { _this.enableChangeInfo(); _this.clinicBackup = data; /* this.router.navigate(['../clinics'], { relativeTo: this.activatedRoute }); */ }, function (error) { alert(error); return; });
                    }
                    else {
                        this.clinicService.addClinic(clinic).subscribe(function (data) { _this.router.navigate(['../clinics'], { relativeTo: _this.activatedRoute }); }, function (error) { alert(error); return; });
                    }
                };
                return ClinicProfileInfoComponent;
            }());
            ClinicProfileInfoComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var DoctorFormComponent = /** @class */ (function () {
                ...
                DoctorFormComponent.prototype.onSubmit = function () {
                    var _this = this;
                    this.submitted = true;
                    ...
                    this.clinicService.addDoctor(doctor).subscribe(function (data) { _this.router.navigate(['../doctors'], { relativeTo: _this.activatedRoute }); }, function (error) { alert(error); return; });
                };
                return DoctorFormComponent;
            }());
            DoctorFormComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var src_app_services_dialog_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! src/app/services/dialog.service */ "./src/app/services/dialog.service.ts");
            var DoctorListingComponent = /** @class */ (function () {
                ...
                DoctorListingComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    this.activatedRoute.params.subscribe(function (params) {
                        _this.clinicID = params.id;
                        _this.clinicName = params.name;
                ...
                DoctorListingComponent.prototype.getDoctors = function () {
                    var _this = this;
                    this.clinicID = this.userService.getUser().clinic_id;
                ...
                DoctorListingComponent.prototype.addNewDoctor = function () {
                    this.router.navigate(['../doctor'], { relativeTo: this.activatedRoute });
                };
                DoctorListingComponent.prototype.deleteDoctor = function (doctor) {
                    var _this = this;
                    this.confirmationDialogService.confirm('Please confirm', 'Are you sure you want to delete doctor: ' + doctor.name + ' ' + doctor.surname + ' ?', false)
                        .then(function (confirmed) {
                        if (confirmed.submited) {
                            _this.clinicService.deleteDoctor(doctor.id).subscribe(function (data) {
                                _this.getDoctors();
                            }, function (error) {
                                alert(error);
                            });
                ...
                DoctorListingComponent.prototype.onSearch = function () {
                    var _this = this;
                    this.submitted = true;
                    var doctor = {
                ...
                DoctorListingComponent.prototype.ngOnDestroy = function () {
                    if (this.navigationSubscription) {
                        this.navigationSubscription.unsubscribe();
                    }
                };
            ...
            DoctorListingComponent.ctorParameters = function () { return [
                { type: src_app_services_clinic_service__WEBPACK_IMPORTED_MODULE_2__["ClinicService"] },
                { type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"] },
                { type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["ActivatedRoute"] },
                { type: src_app_services_user_service__WEBPACK_IMPORTED_MODULE_4__["UserService"] },
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var NewAvailableAppointmentPageComponent = /** @class */ (function () {
                ...
                NewAvailableAppointmentPageComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    this.loadData().then(function () {
                        _this.createFormGroup();
                    }, function () { return alert("Error loading data"); });
                };
                NewAvailableAppointmentPageComponent.prototype.loadData = function () {
                    var _this = this;
                    var promise = new Promise(function (resolve, reject) {
                        _this.loadTypesOfExamination().then(function () {
                            _this.loadOrdinations().then(function () {
                                _this.loadClinicDoctors().then(function () {
                                    resolve();
                ...
                NewAvailableAppointmentPageComponent.prototype.loadClinicDoctors = function () {
                    var _this = this;
                    var promise = new Promise(function (resolve, reject) {
                        var clinic_id = _this.userService.getUser().clinic_id;
                        _this.clinicService.getDoctors(clinic_id).subscribe(function (data) { _this.doctors = data; resolve(); }, function (error) { alert(error); reject(); });
                    });
                    return promise;
                };
                NewAvailableAppointmentPageComponent.prototype.loadTypesOfExamination = function () {
                    var _this = this;
                    var promise = new Promise(function (resolve, reject) {
                        var clinic_id = _this.userService.getUser().clinic_id;
                        _this.clinicService.getTypesOfExamination(clinic_id).subscribe(function (data) { _this.typesOfExamination = data; resolve(); }, function (error) { alert(error); reject(); });
                    });
                    return promise;
                };
                NewAvailableAppointmentPageComponent.prototype.loadOrdinations = function () {
                    var _this = this;
                    var promise = new Promise(function (resolve, reject) {
                        var clinic_id = _this.userService.getUser().clinic_id;
                        _this.clinicService.getOrdinations(clinic_id).subscribe(function (data) { _this.ordinations = data; resolve(); }, function (error) { alert(error); reject(); });
                    });
                    return promise;
                };
                NewAvailableAppointmentPageComponent.prototype.createFormGroup = function () {
                ...
                NewAvailableAppointmentPageComponent.prototype.setPriceFromTypeOfExamination = function () {
                    var _this = this;
                    var type = this.typesOfExamination.find(function (element) { return element.id == _this.form.controls.typeOfExamination.value; });
                    if (!type) {
                ...
                NewAvailableAppointmentPageComponent.prototype.onSubmit = function () {
                    var _this = this;
                    this.submitted = true;
                    if (this.form.invalid) {
                        return;
                    ...
                    this.appointmentService.createAvailableAppointment(appointment).subscribe(function (data) { _this.router.navigate(['../available_appointments'], { relativeTo: _this.activatedRoute }); }, function (error) { alert(error); });
                };
                NewAvailableAppointmentPageComponent.prototype.cancelChanges = function () {
                    this.router.navigate(['../available_appointments'], { relativeTo: this.activatedRoute });
                };
                return NewAvailableAppointmentPageComponent;
            }());
            NewAvailableAppointmentPageComponent.ctorParameters = function () { return [
                { type: _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"] },
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var NurseFormComponent = /** @class */ (function () {
                ...
                NurseFormComponent.prototype.ngOnInit = function () {
                ...
                NurseFormComponent.prototype.onSubmit = function () {
                    var _this = this;
                    this.submitted = true;
                    if (this.loginForm.invalid) {
                        return;
                    ...
                    this.clinicService.addNurse(nurse).subscribe(function (data) { _this.router.navigate(['../nurse_listing'], { relativeTo: _this.activatedRoute }); }, function (error) { alert(error); return; });
                };
                return NurseFormComponent;
            }());
            NurseFormComponent.ctorParameters = function () { return [
                { type: _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"] },
                { type: src_app_services_clinic_service__WEBPACK_IMPORTED_MODULE_3__["ClinicService"] },
                { type: _angular_router__WEBPACK_IMPORTED_MODULE_4__["Router"] },
                { type: _angular_router__WEBPACK_IMPORTED_MODULE_4__["ActivatedRoute"] },
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm2015/router.js");
            /* harmony import */ var src_app_services_user_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! src/app/services/user.service */ "./src/app/services/user.service.ts");
            var NurseListingComponent = /** @class */ (function () {
                ...
                NurseListingComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    this.activatedRoute.params.subscribe(function (params) {
                        _this.clinicID = params.id;
                        _this.clinicName = params.name;
                ...
                NurseListingComponent.prototype.getNurses = function () {
                    var _this = this;
                    this.clinicID = this.userService.getUser().clinic_id;
                ...
                NurseListingComponent.prototype.addNewNurse = function () {
                    this.router.navigate(['../nurse_form'], { relativeTo: this.activatedRoute });
                };
                NurseListingComponent.prototype.deleteNurse = function (nurse) {
                    var _this = this;
                ...
                NurseListingComponent.prototype.onSearch = function () {
                    var _this = this;
                    this.submitted = true;
                    var nurse = {
                        name: this.searchForm.controls.name.value ? this.searchForm.controls.name.value : "",
                ...
                NurseListingComponent.prototype.ngOnDestroy = function () {
                    if (this.navigationSubscription) {
                        this.navigationSubscription.unsubscribe();
                    }
                };
            ...
            NurseListingComponent.ctorParameters = function () { return [
                { type: src_app_services_clinic_service__WEBPACK_IMPORTED_MODULE_3__["ClinicService"] },
                { type: _angular_router__WEBPACK_IMPORTED_MODULE_4__["Router"] },
                { type: _angular_router__WEBPACK_IMPORTED_MODULE_4__["ActivatedRoute"] },
                { type: src_app_services_user_service__WEBPACK_IMPORTED_MODULE_5__["UserService"] },
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm2015/router.js");
            /* harmony import */ var src_app_services_user_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! src/app/services/user.service */ "./src/app/services/user.service.ts");
            var OrdinationFormComponent = /** @class */ (function () {
                ...
                OrdinationFormComponent.prototype.ngOnInit = function () {
                ...
                OrdinationFormComponent.prototype.onSubmit = function () {
                    var _this = this;
                    this.submitted = true;
                    if (this.form.invalid) {
                        return;
                    ...
                    if (this.change === 'Change') {
                        this.clinicService.editOrdination(ordination).subscribe(function (data) { _this.router.navigate(['../ordinations'], { relativeTo: _this.activatedRoute }); }, function (error) { alert(error); return; });
                    }
                    else {
                        this.clinicService.addOrdination(ordination, ordination.clinic_id).subscribe(function (data) { _this.router.navigate(['../ordinations'], { relativeTo: _this.activatedRoute }); }, function (error) { alert(error); return; });
                    }
                };
                return OrdinationFormComponent;
            }());
            OrdinationFormComponent.ctorParameters = function () { return [
                { type: _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"] },
                { type: src_app_services_clinic_service__WEBPACK_IMPORTED_MODULE_3__["ClinicService"] },
                { type: _angular_router__WEBPACK_IMPORTED_MODULE_4__["Router"] },
                { type: _angular_router__WEBPACK_IMPORTED_MODULE_4__["ActivatedRoute"] },
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var src_app_services_user_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! src/app/services/user.service */ "./src/app/services/user.service.ts");
            /* harmony import */ var _angular_forms__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @angular/forms */ "./node_modules/@angular/forms/fesm2015/forms.js");
            var OrdinationListingComponent = /** @class */ (function () {
                function OrdinationListingComponent(clinicService, router, activatedRoute, userService, formBuilder) {
                    ...
                    this.navigationSubscription = this.router.events.subscribe(function (e) {
                        if (e instanceof _angular_router__WEBPACK_IMPORTED_MODULE_3__["NavigationEnd"]) {
                            _this.clinicID = _this.userService.getUser().clinic_id;
                            _this.getOrdinations();
                        }
                    });
                }
                OrdinationListingComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    this.activatedRoute.params.subscribe(function (params) {
                        _this.clinicID = params.id;
                        _this.clinicName = params.name;
                ...
                OrdinationListingComponent.prototype.getOrdinations = function () {
                    var _this = this;
                    this.clinicID = this.userService.getUser().clinic_id;
                    this.clinicService.getOrdinations(this.clinicID).subscribe(function (data) {
                        _this.ordinations = data;
                    }, function (error) {
                        alert(error);
                    });
                };
                OrdinationListingComponent.prototype.changeOrdination = function (ordination) {
                    this.router.navigate(['../ordination_form'], { relativeTo: this.activatedRoute, state: { data: ordination } });
                };
                OrdinationListingComponent.prototype.addNewOrdination = function () {
                    this.router.navigate(['../ordination_form'], { relativeTo: this.activatedRoute });
                };
                OrdinationListingComponent.prototype.deleteOrdination = function (ordination) {
                    var _this = this;
                ...
                OrdinationListingComponent.prototype.onSearch = function () {
                    var _this = this;
                    this.submitted = true;
                    var ordination = {
                        name: this.searchForm.controls.name.value ? this.searchForm.controls.name.value : "",
                ...
                OrdinationListingComponent.prototype.ngOnDestroy = function () {
                    if (this.navigationSubscription) {
                        this.navigationSubscription.unsubscribe();
                    }
                };
            ...
            OrdinationListingComponent.ctorParameters = function () { return [
                { type: src_app_services_clinic_service__WEBPACK_IMPORTED_MODULE_2__["ClinicService"] },
                { type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"] },
                { type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["ActivatedRoute"] },
                { type: src_app_services_user_service__WEBPACK_IMPORTED_MODULE_4__["UserService"] },
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var src_app_services_clinic_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! src/app/services/clinic.service */ "./src/app/services/clinic.service.ts");
            /* harmony import */ var src_app_services_user_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! src/app/services/user.service */ "./src/app/services/user.service.ts");
            var TypeOfExaminationFormComponent = /** @class */ (function () {
                ...
                TypeOfExaminationFormComponent.prototype.ngOnInit = function () {
                ...
                TypeOfExaminationFormComponent.prototype.onSubmit = function () {
                    var _this = this;
                    this.submitted = true;
                    if (this.form.invalid) {
                        return;
                    ...
                    if (this.change === 'Change') {
                        this.clinicService.editTypeOfExamination(typeOfExamination).subscribe(function (data) { _this.router.navigate(['../types_of_examination'], { relativeTo: _this.activatedRoute }); }, function (error) { alert(error); return; });
                    }
                    else {
                        this.clinicService.addTypeOfExamination(typeOfExamination, typeOfExamination.clinic_id).subscribe(function (data) { _this.router.navigate(['../types_of_examination'], { relativeTo: _this.activatedRoute }); }, function (error) { alert(error); return; });
                    }
                };
                return TypeOfExaminationFormComponent;
            }());
            TypeOfExaminationFormComponent.ctorParameters = function () { return [
                { type: _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"] },
                { type: src_app_services_clinic_service__WEBPACK_IMPORTED_MODULE_4__["ClinicService"] },
                { type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"] },
                { type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["ActivatedRoute"] },
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _angular_forms__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @angular/forms */ "./node_modules/@angular/forms/fesm2015/forms.js");
            /* harmony import */ var src_app_services_dialog_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! src/app/services/dialog.service */ "./src/app/services/dialog.service.ts");
            var TypeOfExaminationListingComponent = /** @class */ (function () {
                function TypeOfExaminationListingComponent(clinicService, router, activatedRoute, userService, formBuilder, confirmationDialogService) {
                    ...
                    this.navigationSubscription = this.router.events.subscribe(function (e) {
                        if (e instanceof _angular_router__WEBPACK_IMPORTED_MODULE_3__["NavigationEnd"]) {
                            _this.clinicID = _this.userService.getUser().clinic_id;
                            _this.getTypesOfExamination();
                        }
                    });
                }
                TypeOfExaminationListingComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    this.activatedRoute.params.subscribe(function (params) {
                        _this.clinicID = params.id;
                        _this.clinicName = params.name;
                ...
                TypeOfExaminationListingComponent.prototype.getTypesOfExamination = function () {
                    var _this = this;
                    this.clinicID = this.userService.getUser().clinic_id;
                    this.clinicService.getTypesOfExamination(this.clinicID).subscribe(function (data) {
                        _this.typesOfExamination = data;
                    }, function (error) {
                        alert(error);
                    });
                };
                TypeOfExaminationListingComponent.prototype.changeTypeOfExamination = function (typeOfExamination) {
                    this.router.navigate(['../type_of_examination_info'], { relativeTo: this.activatedRoute, state: { data: typeOfExamination } });
                };
                TypeOfExaminationListingComponent.prototype.addNewTypeOfExamination = function () {
                    this.router.navigate(['../type_of_examination_info'], { relativeTo: this.activatedRoute });
                };
                TypeOfExaminationListingComponent.prototype.deleteTypeOfExamination = function (typeOfExamination) {
                    var _this = this;
                    this.confirmationDialogService.confirm('Please confirm', 'Are you sure you want to delete type of examination: ' + typeOfExamination.name + ' ?', false)
                        .then(function (confirmed) {
                        if (confirmed.submited) {
                            _this.clinicService.deleteTypeOfExamination(typeOfExamination.id).subscribe(function (data) {
                                _this.getTypesOfExamination();
                            }, function (error) {
                                alert(error);
                            });
                ...
                TypeOfExaminationListingComponent.prototype.onSearch = function () {
                    var _this = this;
                    this.submitted = true;
                    var type = {
                        name: this.searchForm.controls.name.value ? this.searchForm.controls.name.value : "",
                ...
                TypeOfExaminationListingComponent.prototype.ngOnDestroy = function () {
                    if (this.navigationSubscription) {
                        this.navigationSubscription.unsubscribe();
                    }
                };
            ...
            TypeOfExaminationListingComponent.ctorParameters = function () { return [
                { type: src_app_services_clinic_service__WEBPACK_IMPORTED_MODULE_2__["ClinicService"] },
                { type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"] },
                { type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["ActivatedRoute"] },
                { type: src_app_services_user_service__WEBPACK_IMPORTED_MODULE_4__["UserService"] },
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var VacationRequestsComponent = /** @class */ (function () {
                ...
                VacationRequestsComponent.prototype.ngOnInit = function () {
                };
                VacationRequestsComponent.prototype.getRequests = function () {
                    var _this = this;
                    this.clinicAdminService.getVacationRequests().subscribe(function (data) {
                        _this.requests = data;
                        for (var i = 0; i < _this.requests.length; i++) {
                            _this.requests[i].startDate = _this.timeConverter(_this.requests[i].startDate);
                            _this.requests[i].endDate = _this.timeConverter(_this.requests[i].endDate);
                        }
                        _this.requests.sort(function (a, b) { return (a.id > b.id) ? 1 : -1; });
                    });
                };
                VacationRequestsComponent.prototype.approveRequest = function (request) {
                    var _this = this;
                    this.confirmationDialogService.confirm('Please confirm', 'Are you sure you want to approve vacation request for ' + request.roles[0] + ': ' + request.staffName + ' ?', false)
                        .then(function (confirmed) {
                        if (confirmed.submited) {
                            _this.clinicAdminService.approveVacationRequest(request).subscribe(function (data) {
                                _this.router.navigate(['../vacation_requests'], { relativeTo: _this.activatedRoute });
                            }, function (error) {
                                alert(error);
                            });
                        }
                    })
                        .catch(function () { return _this.router.navigate(['../vacation_requests'], { relativeTo: _this.activatedRoute }); });
                };
                VacationRequestsComponent.prototype.rejectRequest = function (request) {
                    var _this = this;
                    this.confirmationDialogService.confirm('Please confirm', 'Please provide a reason for deleting request for ' + request.roles[0] + ': ' + request.staffName + ' ?', true)
                        .then(function (confirmed) {
                        if (confirmed.submited) {
                            _this.clinicAdminService.rejectVacationRequest(request, confirmed.explanation).subscribe(function (data) {
                                _this.router.navigate(['../vacation_requests'], { relativeTo: _this.activatedRoute });
                            }, function (error) {
                                alert(error);
                            });
                ...
                VacationRequestsComponent.prototype.timeConverter = function (a) {
                    a = new Date(a * 1000);
                    var months = ['Jan', 'Feb', 'Mar', 'Apr', 'May', 'Jun', 'Jul', 'Aug', 'Sep', 'Oct', 'Nov', 'Dec'];
                    var year = a.getFullYear();
                    var month = months[a.getMonth()];
            ...
            VacationRequestsComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var ngx_cookie_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ngx-cookie-service */ "./node_modules/ngx-cookie-service/ngx-cookie-service.js");
            var AdminPersonalProfileComponent = /** @class */ (function () {
                ...
                AdminPersonalProfileComponent.prototype.ngOnInit = function () {
                    this.getAdminInfo();
                };
                AdminPersonalProfileComponent.prototype.getAdminInfo = function () {
                    var _this = this;
                    this.clinicCenterAdminService.getAdminKc().subscribe(function (data) {
                        _this.admin = data;
                        _this.loginForm = _this.formBuilder.group({
                            name: [_this.admin.name, [_angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required,]],
                            surname: [_this.admin.surname, [_angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required]],
                            email: [_this.admin.email, [_angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required, _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].email]],
                            address: [_this.admin.address, [_angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required]],
                            city: [_this.admin.city, [_angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required]],
                            state: [_this.admin.state, [_angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required]],
                            phoneNumber: [_this.admin.phoneNumber, [_angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required]],
                            upin: [_this.admin.upin, [_angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required, _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].minLength(13), _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].maxLength(13)]]
                        });
                        _this.change = true;
                    });
                    ;
                };
                AdminPersonalProfileComponent.prototype.enableChangeInfo = function () {
                    this.change = !this.change;
                };
                AdminPersonalProfileComponent.prototype.cancelChanges = function () {
                    this.change = !this.change;
                    this.getAdminInfo();
                };
                AdminPersonalProfileComponent.prototype.showChangePasswordForm = function () {
                    this.router.navigate(['../change-password']);
                };
                AdminPersonalProfileComponent.prototype.onSubmit = function () {
                    var _this = this;
                    this.submitted = true;
                    if (this.loginForm.invalid) {
                        return;
                    ...
                    this.clinicCenterAdminService.changeAdminKc(adminKc).subscribe(function (data) { _this.change = !_this.change; return; }, function (error) { alert(error); });
                };
                return AdminPersonalProfileComponent;
            }());
            AdminPersonalProfileComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var AdminProfileComponent = /** @class */ (function () {
                ...
                AdminProfileComponent.prototype.loadClinics = function () {
                };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _angular_forms__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @angular/forms */ "./node_modules/@angular/forms/fesm2015/forms.js");
            /* harmony import */ var ngx_cookie_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ngx-cookie-service */ "./node_modules/ngx-cookie-service/ngx-cookie-service.js");
            var ClinicAdminFormComponent = /** @class */ (function () {
                ...
                ClinicAdminFormComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    this.form = this.formBuilder.group({
                ...
                ClinicAdminFormComponent.prototype.onSubmit = function () {
                    var _this = this;
                    this.submitted = true;
                    var adminC = {
                        id: null,
                    ...
                    this.clinicService.addAdmin(adminC).subscribe(function (data) { _this.router.navigate(['../clinicAdmins', { id: _this.clinicID, name: _this.clinicName }], { relativeTo: _this.activatedRoute }); }, function (error) { alert(error); });
                };
                return ClinicAdminFormComponent;
            }());
            ClinicAdminFormComponent.ctorParameters = function () { return [
                { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] },
                { type: src_app_services_clinic_service__WEBPACK_IMPORTED_MODULE_3__["ClinicService"] },
                { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"] },
                { type: _angular_forms__WEBPACK_IMPORTED_MODULE_4__["FormBuilder"] },
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ClinicAdministratorsListingComponent = /** @class */ (function () {
                ...
                ClinicAdministratorsListingComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    this.activatedRoute.params.subscribe(function (params) {
                        _this.clinicID = params.id;
                        _this.clinicName = params.name;
                        _this.getClinicAdministrators();
                    });
                };
                ClinicAdministratorsListingComponent.prototype.getClinicAdministrators = function () {
                    var _this = this;
                    this.clinicService.getClinicAdmins(this.clinicID).subscribe(function (data) {
                        _this.admins = data;
                    });
                };
                ClinicAdministratorsListingComponent.prototype.deleteAdmin = function (admin) {
                    var _this = this;
                    this.confirmationDialogService.confirm('Please confirm', 'Are you sure you want to delete clinic administrator: ' + admin.name + ' ' + admin.surname + ' ?', false)
                        .then(function (confirmed) {
                        if (confirmed.submited) {
                            _this.clinicCenterAdminService.deleteClinicAdmin(admin).subscribe(function (data) {
                                _this.getClinicAdministrators();
                ...
                ClinicAdministratorsListingComponent.prototype.addAdministrator = function () {
            ...
            ClinicAdministratorsListingComponent.ctorParameters = function () { return [
                { type: src_app_services_clinic_service__WEBPACK_IMPORTED_MODULE_3__["ClinicService"] },
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ClinicFormComponent = /** @class */ (function () {
                ...
                ClinicFormComponent.prototype.onSubmit = function () {
                    var _this = this;
                    var clinic = {
                        name: this.name,
                    ...
                    this.clinicService.addClinic(clinic).subscribe(function (data) { _this.router.navigate(['../clinics'], { relativeTo: _this.activatedRoute }); }, function (error) { return alert(error); });
                };
                return ClinicFormComponent;
            }());
            ClinicFormComponent.ctorParameters = function () { return [
                { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] },
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm2015/router.js");
            /* harmony import */ var src_app_services_dialog_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! src/app/services/dialog.service */ "./src/app/services/dialog.service.ts");
            var ClinicListingComponent = /** @class */ (function () {
                ...
                ClinicListingComponent.prototype.ngOnInit = function () {
                };
                ClinicListingComponent.prototype.getClinics = function () {
                    var _this = this;
                    this.clinicService.getClinics().subscribe(function (data) {
                        _this.clinics = data;
                        _this.clinics.sort(function (a, b) { return (a.id > b.id) ? 1 : -1; });
                    });
                };
                ClinicListingComponent.prototype.showClinicInfo = function (clinic) {
                    this.router.navigate(['showClinicInfo'], { relativeTo: this.activatedRoute, state: { data: clinic } });
                };
                ClinicListingComponent.prototype.showClinicAdmins = function (clinic) {
                    this.router.navigate(['clinicAdmins', { id: clinic.id, name: clinic.name }], { relativeTo: this.activatedRoute });
                };
                ClinicListingComponent.prototype.showNewClinicForm = function () {
                    this.router.navigate(['addClinic'], { relativeTo: this.activatedRoute });
                };
                ClinicListingComponent.prototype.deleteClinic = function (clinic) {
                    var _this = this;
                    this.confirmationDialogService.confirm('Please confirm', 'Are you sure you want to delete clinic: ' + clinic.name + ' ?', false)
                        .then(function (confirmed) {
                        if (confirmed.submited) {
                            _this.clinicService.deleteClinic(clinic).subscribe(function (data) {
                                _this.router.navigate(['../adminCC'], { relativeTo: _this.activatedRoute });
                            }, function (error) {
                                alert(error);
                            });
                        }
                ...
                ClinicListingComponent.prototype.ngOnDestroy = function () {
                    if (this.navigationSubscription) {
                        this.navigationSubscription.unsubscribe();
                    }
                };
            ...
            ClinicListingComponent.ctorParameters = function () { return [
                { type: src_app_services_clinic_service__WEBPACK_IMPORTED_MODULE_2__["ClinicService"] },
                { type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"] },
                { type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["ActivatedRoute"] },
                { type: src_app_services_dialog_service__WEBPACK_IMPORTED_MODULE_4__["DialogService"] }
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm2015/router.js");
            /* harmony import */ var src_app_services_dialog_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! src/app/services/dialog.service */ "./src/app/services/dialog.service.ts");
            var DiagnosisFormComponent = /** @class */ (function () {
                ...
                DiagnosisFormComponent.prototype.onSubmit = function () {
                    var _this = this;
                ...
                DiagnosisFormComponent.prototype.submitOrEdit = function () {
                    var _this = this;
                    this.submitted = true;
                    if (this.form.invalid) {
                        return;
                    ...
                    if (this.diagnosis_id) {
                        this.clinicalCenterService.editDiagnosis(diagnosis).subscribe(function (data) { _this.router.navigate(['../diagnoses'], { relativeTo: _this.activatedRoute }); }, function (error) { alert(error); return; });
                    }
                    else {
                        this.clinicalCenterService.addDiagnosis(diagnosis).subscribe(function (data) { _this.router.navigate(['../diagnoses'], { relativeTo: _this.activatedRoute }); }, function (error) { alert(error); return; });
                    }
                };
                return DiagnosisFormComponent;
            }());
            DiagnosisFormComponent.ctorParameters = function () { return [
                { type: _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"] },
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var src_app_services_clinical_center_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! src/app/services/clinical-center.service */ "./src/app/services/clinical-center.service.ts");
            /* harmony import */ var src_app_services_dialog_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! src/app/services/dialog.service */ "./src/app/services/dialog.service.ts");
            var DiagnosisListingComponent = /** @class */ (function () {
                ...
                DiagnosisListingComponent.prototype.ngOnInit = function () {
                };
                DiagnosisListingComponent.prototype.getDiagnosis = function () {
                    var _this = this;
                    this.clinicalCenterService.getDiagnosis().subscribe(function (data) {
                        _this.diagnoses = data;
                    });
                };
                DiagnosisListingComponent.prototype.openDiagnosisForm = function (diagnosis) {
                    this.router.navigate(['../diagnosis_info'], { relativeTo: this.activatedRoute, state: { data: diagnosis } });
                };
                DiagnosisListingComponent.prototype.deleteDiagnosis = function (diagnosis) {
                    var _this = this;
                    this.confirmationDialogService.confirm('Please confirm', 'Are you sure you want to delete diagnosis with code: ' + diagnosis.code + ' ?', false)
                        .then(function (confirmed) {
                        if (confirmed.submited) {
                            _this.clinicalCenterService.deleteDiagnosis(diagnosis.id).subscribe(function (data) { return _this.getDiagnosis(); }, function (error) { return alert(error); });
                        }
                    });
                };
                DiagnosisListingComponent.prototype.ngOnDestroy = function () {
                    if (this.navigationSubscription) {
                        this.navigationSubscription.unsubscribe();
                    }
                };
            ...
            DiagnosisListingComponent.ctorParameters = function () { return [
                { type: src_app_services_clinical_center_service__WEBPACK_IMPORTED_MODULE_3__["ClinicalCenterService"] },
                { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] },
                { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"] },
                { type: src_app_services_dialog_service__WEBPACK_IMPORTED_MODULE_4__["DialogService"] }
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm2015/router.js");
            /* harmony import */ var src_app_services_dialog_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! src/app/services/dialog.service */ "./src/app/services/dialog.service.ts");
            var MedicationFormComponent = /** @class */ (function () {
                ...
                MedicationFormComponent.prototype.ngOnInit = function () {
                ...
                MedicationFormComponent.prototype.onSubmit = function () {
                    var _this = this;
                ...
                MedicationFormComponent.prototype.submitOrEdit = function () {
                    var _this = this;
                    this.submitted = true;
                    if (this.form.invalid) {
                        return;
                    ...
                    if (this.medication_id) {
                        this.clinicalCenterService.editMedication(medication).subscribe(function (data) { _this.router.navigate(['../medications'], { relativeTo: _this.activatedRoute }); }, function (error) { alert(error); return; });
                    }
                    else {
                        this.clinicalCenterService.addMedication(medication).subscribe(function (data) { _this.router.navigate(['../medications'], { relativeTo: _this.activatedRoute }); }, function (error) { alert(error); return; });
                    }
                };
                return MedicationFormComponent;
            }());
            MedicationFormComponent.ctorParameters = function () { return [
                { type: _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"] },
                { type: src_app_services_clinical_center_service__WEBPACK_IMPORTED_MODULE_3__["ClinicalCenterService"] },
                { type: _angular_router__WEBPACK_IMPORTED_MODULE_4__["Router"] },
                { type: _angular_router__WEBPACK_IMPORTED_MODULE_4__["ActivatedRoute"] },
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var src_app_services_clinical_center_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! src/app/services/clinical-center.service */ "./src/app/services/clinical-center.service.ts");
            /* harmony import */ var src_app_services_dialog_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! src/app/services/dialog.service */ "./src/app/services/dialog.service.ts");
            var MedicationListingComponent = /** @class */ (function () {
                ...
                MedicationListingComponent.prototype.ngOnInit = function () {
                };
                MedicationListingComponent.prototype.getMedications = function () {
                    var _this = this;
                    this.clinicalCenterService.getMedications().subscribe(function (data) {
                        _this.medications = data;
                    });
                };
                MedicationListingComponent.prototype.openMedicationForm = function (medication) {
                    this.router.navigate(['../medication_info'], { relativeTo: this.activatedRoute, state: { data: medication } });
                };
                MedicationListingComponent.prototype.deleteMedication = function (medication) {
                    var _this = this;
                    this.confirmationDialogService.confirm('Please confirm', 'Are you sure you want to delete medication with code: ' + medication.code + ' ?', false)
                        .then(function (confirmed) {
                        if (confirmed.submited) {
                            _this.clinicalCenterService.deleteMedication(medication.id).subscribe(function (data) { return _this.getMedications(); }, function (error) { return alert(error); });
                        }
                    });
                };
                MedicationListingComponent.prototype.ngOnDestroy = function () {
                    if (this.navigationSubscription) {
                        this.navigationSubscription.unsubscribe();
                    }
                };
            ...
            MedicationListingComponent.ctorParameters = function () { return [
                { type: src_app_services_clinical_center_service__WEBPACK_IMPORTED_MODULE_3__["ClinicalCenterService"] },
                { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] },
                { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"] },
                { type: src_app_services_dialog_service__WEBPACK_IMPORTED_MODULE_4__["DialogService"] }
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm2015/router.js");
            /* harmony import */ var src_app_services_dialog_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! src/app/services/dialog.service */ "./src/app/services/dialog.service.ts");
            var RegistrationListingComponent = /** @class */ (function () {
                ...
                RegistrationListingComponent.prototype.ngOnInit = function () {
                };
                RegistrationListingComponent.prototype.getRequests = function () {
                    var _this = this;
                ...
                RegistrationListingComponent.prototype.approveRequest = function (request) {
                    var _this = this;
                    this.confirmationDialogService.confirm('Please confirm', 'Are you sure you want to approve reqistration request for user: ' + request.name + ' ?', false)
                        .then(function (confirmed) {
                        if (confirmed.submited) {
                            _this.clinicCenterAdminService.approveRequest(request).subscribe(function (data) {
                                _this.router.navigate(['../registrationRequests'], { relativeTo: _this.activatedRoute });
                            }, function (error) {
                                alert(error);
                            });
                        }
                    })
                        .catch(function () { return _this.router.navigate(['../registrationRequests'], { relativeTo: _this.activatedRoute }); });
                };
                RegistrationListingComponent.prototype.deleteRequest = function (request) {
                    var _this = this;
                    this.confirmationDialogService.confirm('Please confirm', 'Please provide a reason for deleting request for user: ' + request.name + ' ?', true)
                        .then(function (confirmed) {
                        if (confirmed.submited) {
                            _this.clinicCenterAdminService.deleteRequest(request, confirmed.explanation).subscribe(function (data) {
                                _this.router.navigate(['../registrationRequests'], { relativeTo: _this.activatedRoute });
                            }, function (error) {
                                alert(error);
                            });
                ...
                RegistrationListingComponent.prototype.showRequestInfo = function (info) {
                    //to do 
                };
                return RegistrationListingComponent;
            }());
            RegistrationListingComponent.ctorParameters = function () { return [
                { type: _services_clinic_center_admin_service__WEBPACK_IMPORTED_MODULE_1__["ClinicCenterAdminService"] },
                { type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"] },
                { type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["ActivatedRoute"] },
                { type: src_app_services_dialog_service__WEBPACK_IMPORTED_MODULE_4__["DialogService"] }
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ChangePasswordComponent = /** @class */ (function () {
                ...
                ChangePasswordComponent.prototype.canExit = function () {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var DoctorCalendarComponent = /** @class */ (function () {
                function DoctorCalendarComponent(doctorService, router, activatedRoute, modal, cookieService) {
                    var _this = this;
                ...
                DoctorCalendarComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    ...
                    this.doctorService.getAppointments().subscribe(function (data) {
                        _this.populateCalendarEvents(data);
                    }, function (error) {
                        alert(error);
                    });
                    this.doctorService.getVacations().subscribe(function (data) {
                        _this.populateVacations(data);
                    }, function (error) {
                        alert(error);
                    });
                };
                DoctorCalendarComponent.prototype.dayClicked = function (_a) {
                ...
                DoctorCalendarComponent.prototype.eventTimesChanged = function (_a) {
                ...
                DoctorCalendarComponent.prototype.handleEvent = function (action, event) {
                    var _this = this;
                    var appointment = {};
                    this.doctorService.getOneAppointment(event.id).subscribe(function (data) {
                        appointment = data;
                        _this.modalData = { appointment: appointment, action: action };
                        _this.modal.open(_this.modalContent, { size: 'lg' });
                    }, function (error) {
                        alert(error);
                    });
                };
                DoctorCalendarComponent.prototype.addEvent = function () {
                ...
                DoctorCalendarComponent.prototype.deleteEvent = function (eventToDelete) {
                    this.events = this.events.filter(function (event) { return event !== eventToDelete; });
                };
                DoctorCalendarComponent.prototype.setView = function (view) {
                    this.view = view;
                };
                DoctorCalendarComponent.prototype.closeOpenMonthViewDay = function () {
                    this.activeDayIsOpen = false;
                };
                // TODO: Izdvojiti operacije, preglede i godisnje odmore po bojama i u kodu
                DoctorCalendarComponent.prototype.populateCalendarEvents = function (data) {
                    var _this = this;
                    data.forEach(function (appointment) {
                        ...
                        _this.events.push(eventToAdd);
                    });
                };
                DoctorCalendarComponent.prototype.populateVacations = function (data) {
                    var _this = this;
                ...
                DoctorCalendarComponent.prototype.timeConverter = function (a) {
                    a = new Date(a * 1000);
                    var months = ['Jan', 'Feb', 'Mar', 'Apr', 'May', 'Jun', 'Jul', 'Aug', 'Sep', 'Oct', 'Nov', 'Dec'];
                    var year = a.getFullYear();
                    var month = months[a.getMonth()];
                ...
                DoctorCalendarComponent.prototype.startExamination = function () {
                    this.modal.dismissAll();
                    //TODO
                    //this.router.navigate(['../examination'], { relativeTo: this.activatedRoute, state: {data: clinic}});
                };
                DoctorCalendarComponent.prototype.close = function () {
                    this.modal.dismissAll();
                };
                return DoctorCalendarComponent;
            }());
            DoctorCalendarComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var DoctorHomeComponent = /** @class */ (function () {
                ...
                DoctorHomeComponent.prototype.ngOnInit = function () {
                };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
            /* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
            var DoctorMyProfileComponent = /** @class */ (function () {
                function DoctorMyProfileComponent() {
                }
                DoctorMyProfileComponent.prototype.ngOnInit = function () {
                };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var DoctorProfileComponent = /** @class */ (function () {
                ...
                DoctorProfileComponent.prototype.getDoctorInfo = function () {
                    var _this = this;
                    this.doctorService.getDoctor().subscribe(function (data) {
                        _this.doctor = data;
                        _this.loginForm = _this.formBuilder.group({
                            name: [_this.doctor.name, [_angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required,]],
                            surname: [_this.doctor.surname, [_angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required]],
                            email: [_this.doctor.email, [_angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required, _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].email]],
                            address: [_this.doctor.address, [_angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required]],
                            city: [_this.doctor.city, [_angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required]],
                            state: [_this.doctor.state, [_angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required]],
                            phoneNumber: [_this.doctor.phoneNumber, [_angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required]],
                            upin: [_this.doctor.upin, [_angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required, _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].minLength(13), _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].maxLength(13)]]
                        });
                        _this.change = true;
                    });
                };
                DoctorProfileComponent.prototype.showChangePasswordForm = function () {
                    this.router.navigate(['../change-password']);
                };
                DoctorProfileComponent.prototype.enableChangeInfo = function () {
                    this.change = !this.change;
                };
                DoctorProfileComponent.prototype.cancelChanges = function () {
                    this.change = !this.change;
                    this.getDoctorInfo();
                };
                DoctorProfileComponent.prototype.onSubmit = function () {
                    ...
                    this.doctorService.changeDoctor(doctor).subscribe(function (data) { _this.change = !_this.change; return; }, function (error) { alert(error); });
                };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var NewAppointmentPageComponent = /** @class */ (function () {
                function NewAppointmentPageComponent(formBuilder, userService, clinicService, patientService, activatedRoute, appointmentService) {
                    this.formBuilder = formBuilder;
                    this.userService = userService;
                    this.clinicService = clinicService;
                ...
                NewAppointmentPageComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    this.activatedRoute.queryParams.subscribe(function (params) {
                        var time = params['time'];
                        if (time) {
                            _this.startAppointmentNow = true;
                        }
                        else {
                            _this.startAppointmentNow = false;
                        }
                    });
                    this.sub = this.activatedRoute.params.subscribe(function (params) {
                        var patient_id = +params['patient_id'];
                        _this.loadData(patient_id).then(function () {
                            _this.createFormGroup();
                        }, function () { return alert("Error loading data"); });
                    });
                };
                NewAppointmentPageComponent.prototype.loadData = function (patient_id) {
                    var _this = this;
                    var promise = new Promise(function (resolve, reject) {
                        _this.loadPatientInfo(patient_id).then(function () {
                            _this.loadTypesOfExamination().then(function () {
                                _this.loadOrdinations().then(function () {
                                    resolve();
                                }, function () { return reject(); });
                ...
                NewAppointmentPageComponent.prototype.loadPatientInfo = function (patient_id) {
                    var _this = this;
                    var promise = new Promise(function (resolve, reject) {
                        _this.patientService.getPatientById(patient_id).subscribe(function (data) { _this.patient = data; resolve(); }, function (error) { alert(error); reject(); });
                    });
                    return promise;
                };
                NewAppointmentPageComponent.prototype.loadTypesOfExamination = function () {
                    var _this = this;
                    var promise = new Promise(function (resolve, reject) {
                        var clinic_id = _this.userService.getUser().clinic_id;
                        _this.clinicService.getTypesOfExamination(clinic_id).subscribe(function (data) { _this.typesOfExamination = data; resolve(); }, function (error) { alert(error); reject(); });
                ...
                NewAppointmentPageComponent.prototype.loadOrdinations = function () {
                    var _this = this;
                    var promise = new Promise(function (resolve, reject) {
                        var clinic_id = _this.userService.getUser().clinic_id;
                        _this.clinicService.getOrdinations(clinic_id).subscribe(function (data) { _this.ordinations = data; resolve(); }, function (error) { alert(error); reject(); });
                ...
                NewAppointmentPageComponent.prototype.createFormGroup = function () {
                    var date;
                ...
                NewAppointmentPageComponent.prototype.setPriceFromTypeOfExamination = function () {
                    var _this = this;
                    var type = this.typesOfExamination.find(function (element) { return element.id == _this.form.controls.typeOfExamination.value; });
                    if (!type) {
                        this.form.controls['price'].setValue("");
                ...
                NewAppointmentPageComponent.prototype.onSubmit = function () {
                    this.submitted = true;
                    if (this.form.invalid) {
                        return;
                    }
                    ...
                    if (this.startAppointmentNow) {
                        this.appointmentService.startAppointment(appointment).subscribe(function (data) { alert("Appointment started"); /* rutirati na stranicu za evidecniju o pregledu */ }, function (error) { alert(error); });
                    }
                    else {
                    }
                };
                NewAppointmentPageComponent.prototype.cancelChanges = function () {
                };
                NewAppointmentPageComponent.prototype.ngOnDestroy = function () {
                    this.sub.unsubscribe();
                };
                return NewAppointmentPageComponent;
            }());
            NewAppointmentPageComponent.ctorParameters = function () { return [
                { type: _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"] },
                { type: src_app_services_user_service__WEBPACK_IMPORTED_MODULE_4__["UserService"] },
                { type: src_app_services_clinic_service__WEBPACK_IMPORTED_MODULE_3__["ClinicService"] },
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var NewVacationRequestComponent = /** @class */ (function () {
                ...
                NewVacationRequestComponent.prototype.ngOnInit = function () {
                    this.createFormGroup();
                };
                NewVacationRequestComponent.prototype.createFormGroup = function () {
                    this.form = this.formBuilder.group({
                ...
                NewVacationRequestComponent.prototype.onSubmit = function () {
                    var _this = this;
                    this.submitted = true;
                    if (this.form.invalid) {
                        return;
                    ...
                    this.vacationService.sendRequest(vacation).subscribe(function (data) { _this.router.navigate(['../profile'], { relativeTo: _this.activatedRoute }); }, function (error) { alert(error); });
                };
                NewVacationRequestComponent.prototype.cancelChanges = function () {
                };
                return NewVacationRequestComponent;
            }());
            NewVacationRequestComponent.ctorParameters = function () { return [
                { type: _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"] },
                { type: src_app_services_user_service__WEBPACK_IMPORTED_MODULE_3__["UserService"] },
                { type: _angular_router__WEBPACK_IMPORTED_MODULE_4__["Router"] },
                { type: _angular_router__WEBPACK_IMPORTED_MODULE_4__["ActivatedRoute"] },
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var PatientListingComponent = /** @class */ (function () {
                ...
                PatientListingComponent.prototype.ngOnInit = function () {
                    this.searchForm = this.formBuilder.group({
                        name: [""],
                        surname: [""],
                        upin: [""]
                ...
                PatientListingComponent.prototype.getPatients = function () {
                    var _this = this;
                ...
                PatientListingComponent.prototype.onSearch = function () {
                    var _this = this;
                    this.submitted = true;
                    var patient = {
                        name: this.searchForm.controls.name.value ? this.searchForm.controls.name.value : "",
                ...
                PatientListingComponent.prototype.onFilterChanges = function () {
                    var _this = this;
                    this.filterForm.valueChanges.subscribe(function (filters) {
                        _this.filteredPatients = _this.filterPatients(filters);
                    });
                };
                PatientListingComponent.prototype.filterPatients = function (filters) {
                    return this.patients.filter(function (patient) { return patient.name.toLowerCase().indexOf(filters.name.toLowerCase()) !== -1 &&
                        patient.surname.toLowerCase().indexOf(filters.surname.toLowerCase()) !== -1 &&
                        patient.upin.indexOf(filters.upin) !== -1; });
                };
                PatientListingComponent.prototype.ShowMedicalRecord = function (patient) {
                    var _this = this;
                    this.patientService.checkAuthorityToViewMedicalRecord(patient.id).subscribe(function (data) {
                        ...
                        _this.modalData = { patientID: patientID, patientName: patientName, action: action };
                        _this.modal.open(_this.modalContent, { size: 'xl' });
                    }, function (error) {
                        alert(error);
                    });
                };
                PatientListingComponent.prototype.close = function () {
                    this.modal.dismissAll();
                };
                PatientListingComponent.prototype.startAppointment = function (patient_id) {
                    this.router.navigate(["../new_appointment/" + patient_id], { queryParams: { time: 'now' }, relativeTo: this.activatedRoute });
                };
                PatientListingComponent.prototype.ngOnDestroy = function () {
                    if (this.navigationSubscription) {
                        this.navigationSubscription.unsubscribe();
                    }
                };
            ...
            PatientListingComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var NurseCalendarComponent = /** @class */ (function () {
                ...
                NurseCalendarComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    var user = JSON.parse(this.cookieService.get('user'));
                    this.daystart = parseInt(user.shiftStart);
                    this.dayend = parseInt(user.shiftEnd);
                ...
                NurseCalendarComponent.prototype.dayClicked = function (_a) {
                    var date = _a.date, events = _a.events;
                    if (Object(date_fns__WEBPACK_IMPORTED_MODULE_3__["isSameMonth"])(date, this.viewDate)) {
                        if ((Object(date_fns__WEBPACK_IMPORTED_MODULE_3__["isSameDay"])(this.viewDate, date) && this.activeDayIsOpen === true) ||
                            events.length === 0) {
                ...
                NurseCalendarComponent.prototype.eventTimesChanged = function (_a) {
                    var event = _a.event, newStart = _a.newStart, newEnd = _a.newEnd;
                    this.events = this.events.map(function (iEvent) {
                        if (iEvent === event) {
                            return Object.assign({}, event, { start: newStart, end: newEnd });
                ...
                NurseCalendarComponent.prototype.handleEvent = function (action, event) {
                    this.modalData = { event: event, action: action };
                    this.modal.open(this.modalContent, { size: 'lg' });
                };
                NurseCalendarComponent.prototype.deleteEvent = function (eventToDelete) {
                    this.events = this.events.filter(function (event) { return event !== eventToDelete; });
                };
                NurseCalendarComponent.prototype.setView = function (view) {
                    this.view = view;
                };
                NurseCalendarComponent.prototype.closeOpenMonthViewDay = function () {
                    this.activeDayIsOpen = false;
                };
                // TODO: Izdvojiti operacije, preglede i godisnje odmore po bojama i u kodu
                NurseCalendarComponent.prototype.populateCalendarEvents = function (data) {
                    var _this = this;
                    data.forEach(function (appointment) {
                        var eventToAdd = {
                ...
                NurseCalendarComponent.prototype.timeConverter = function (a) {
                    var months = ['Jan', 'Feb', 'Mar', 'Apr', 'May', 'Jun', 'Jul', 'Aug', 'Sep', 'Oct', 'Nov', 'Dec'];
                    var year = a.getFullYear();
                    var month = months[a.getMonth()];
                    var date = a.getDate();
                ...
                NurseCalendarComponent.prototype.close = function () {
                    this.modal.dismissAll();
                };
                return NurseCalendarComponent;
            }());
            NurseCalendarComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var src_app_services_user_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! src/app/services/user.service */ "./src/app/services/user.service.ts");
            /* harmony import */ var _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! @ng-bootstrap/ng-bootstrap */ "./node_modules/@ng-bootstrap/ng-bootstrap/fesm2015/ng-bootstrap.js");
            var NursePatientListingComponent = /** @class */ (function () {
                ...
                NursePatientListingComponent.prototype.ngOnInit = function () {
                    this.searchForm = this.formBuilder.group({
                        name: [""],
                        surname: [""],
                        upin: [""]
                ...
                NursePatientListingComponent.prototype.getPatients = function () {
                    var _this = this;
                    this.patientService.getClinicPatients().subscribe(function (data) {
                        _this.patients = data;
                        _this.filteredPatients = data;
                ...
                NursePatientListingComponent.prototype.onSearch = function () {
                    var _this = this;
                    this.submitted = true;
                    var patient = {
                        name: this.searchForm.controls.name.value ? this.searchForm.controls.name.value : "",
                ...
                NursePatientListingComponent.prototype.onFilterChanges = function () {
                    var _this = this;
                    this.filterForm.valueChanges.subscribe(function (filters) {
                        _this.filteredPatients = _this.filterPatients(filters);
                    });
                };
                NursePatientListingComponent.prototype.filterPatients = function (filters) {
                    return this.patients.filter(function (patient) { return patient.name.toLowerCase().indexOf(filters.name.toLowerCase()) !== -1 &&
                        patient.surname.toLowerCase().indexOf(filters.surname.toLowerCase()) !== -1 &&
                        patient.upin.indexOf(filters.upin) !== -1; });
                };
                NursePatientListingComponent.prototype.ShowMedicalRecord = function (patient) {
                    //TODO
                    var action = "Opened";
                    var patientID = patient.id;
                    var patientName = patient.name + " " + patient.surname;
                    this.modalData = { patientID: patientID, patientName: patientName, action: action };
                    this.modal.open(this.modalContent, { size: 'xl' });
                };
                NursePatientListingComponent.prototype.close = function () {
                    this.modal.dismissAll();
                };
                NursePatientListingComponent.prototype.timeConverter = function (a) {
                    a = new Date(a * 1000);
                    var months = ['Jan', 'Feb', 'Mar', 'Apr', 'May', 'Jun', 'Jul', 'Aug', 'Sep', 'Oct', 'Nov', 'Dec'];
                    var year = a.getFullYear();
                    var month = months[a.getMonth()];
                ...
                NursePatientListingComponent.prototype.sortName = function () {
                    this.sortingOption = "name";
                    this.sortPatients();
                };
                NursePatientListingComponent.prototype.sortUpin = function () {
                    this.sortingOption = "upin";
                    this.sortPatients();
                };
                NursePatientListingComponent.prototype.sortAddress = function () {
                    this.sortingOption = "address";
                    this.sortPatients();
                };
                NursePatientListingComponent.prototype.sortCity = function () {
                    this.sortingOption = "city";
                    this.sortPatients();
                };
                NursePatientListingComponent.prototype.sortState = function () {
                    this.sortingOption = "state";
                    this.sortPatients();
                };
                NursePatientListingComponent.prototype.sortPatients = function () {
                    switch (this.sortingOption) {
                        ...
                        case "address": {
                            this.patients.sort(function (a, b) { return (a.address > b.address) ? 1 : -1; });
                            break;
                        }
                        case "city": {
                            this.patients.sort(function (a, b) { return (a.city > b.city) ? 1 : -1; });
                            break;
                        }
                        case "state": {
                            this.patients.sort(function (a, b) { return (a.state > b.state) ? 1 : -1; });
                            break;
                        }
                        case "upin": {
                            this.patients.sort(function (a, b) { return (a.upin > b.upin) ? 1 : -1; });
                            break;
                        }
                        default: {
                            this.patients.sort(function (a, b) { return (a.id > b.id) ? 1 : -1; });
                            break;
                        }
                    }
                };
                NursePatientListingComponent.prototype.ngOnDestroy = function () {
                    if (this.navigationSubscription) {
                        this.navigationSubscription.unsubscribe();
                    }
                };
            ...
            NursePatientListingComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm2015/router.js");
            var NursePersonalProfileComponent = /** @class */ (function () {
                function NursePersonalProfileComponent(nurseService, formBuilder, router) {
                    this.nurseService = nurseService;
                    this.formBuilder = formBuilder;
                    this.router = router;
                }
                NursePersonalProfileComponent.prototype.ngOnInit = function () {
                    this.getNurseInfo();
                };
                NursePersonalProfileComponent.prototype.getNurseInfo = function () {
                    var _this = this;
                    this.nurseService.getNurse().subscribe(function (data) {
                        _this.nurse = data;
                        _this.form = _this.formBuilder.group({
                            name: [_this.nurse.name, [_angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required,]],
                            surname: [_this.nurse.surname, [_angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required]],
                            email: [_this.nurse.email, [_angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required, _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].email]],
                            address: [_this.nurse.address, [_angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required]],
                            city: [_this.nurse.city, [_angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required]],
                            state: [_this.nurse.state, [_angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required]],
                            phoneNumber: [_this.nurse.phoneNumber, [_angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required]],
                            upin: [_this.nurse.upin, [_angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required, _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].minLength(13), _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].maxLength(13)]]
                        });
                        _this.change = true;
                    }, function (error) {
                        alert(error);
                ...
                NursePersonalProfileComponent.prototype.enableChangeInfo = function () {
                    this.change = !this.change;
                };
                NursePersonalProfileComponent.prototype.cancelChanges = function () {
                    this.change = !this.change;
                    this.getNurseInfo();
                };
                NursePersonalProfileComponent.prototype.showChangePasswordForm = function () {
                    this.router.navigate(['../change-password']);
                };
                NursePersonalProfileComponent.prototype.onSubmit = function () {
                    var _this = this;
                    this.submitted = true;
                    if (this.form.invalid) {
                        return;
                    ...
                    this.nurseService.changeNurse(nurse).subscribe(function (data) { _this.change = !_this.change; return; }, function (error) { alert(error); });
                };
                return NursePersonalProfileComponent;
            }());
            NursePersonalProfileComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var PrescriptionListingComponent = /** @class */ (function () {
                function PrescriptionListingComponent(clinicService, router, activatedRoute, userService, formBuilder, confirmationDialogService) {
                    ...
                    this.navigationSubscription = this.router.events.subscribe(function (e) {
                        if (e instanceof _angular_router__WEBPACK_IMPORTED_MODULE_5__["NavigationEnd"]) {
                            _this.clinicID = _this.userService.getUser().clinic_id;
                            _this.getPrescriptions();
                        }
                    });
                }
                PrescriptionListingComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    this.activatedRoute.params.subscribe(function (params) {
                        _this.clinicID = params.id;
                        _this.clinicName = params.name;
                ...
                PrescriptionListingComponent.prototype.getPrescriptions = function () {
                    var _this = this;
                    this.clinicID = this.userService.getUser().clinic_id;
                    this.clinicService.getPrescriptions(this.clinicID).subscribe(function (data) {
                        _this.prescriptions = data;
                    }, function (error) {
                        alert(error);
                    });
                };
                PrescriptionListingComponent.prototype.approvePrescription = function (prescription) {
                    var _this = this;
                    this.confirmationDialogService.confirm('Please confirm', 'Are you sure you want to approve prescription for medication: ' + prescription.medication_name + ' ?', false)
                        .then(function (confirmed) {
                        if (confirmed.submited) {
                            _this.clinicService.approvePrescription(prescription).subscribe(function (data) {
                                _this.getPrescriptions();
                            }, function (error) {
                                alert(error);
                            });
                ...
                PrescriptionListingComponent.prototype.onSearch = function () {
                    var _this = this;
                    this.submitted = true;
                    var prescription = {
                        name: this.searchForm.controls.name.value ? this.searchForm.controls.name.value : "",
                ...
                PrescriptionListingComponent.prototype.ngOnDestroy = function () {
                    if (this.navigationSubscription) {
                        this.navigationSubscription.unsubscribe();
                    }
                };
            ...
            PrescriptionListingComponent.ctorParameters = function () { return [
                { type: src_app_services_clinic_service__WEBPACK_IMPORTED_MODULE_4__["ClinicService"] },
                { type: _angular_router__WEBPACK_IMPORTED_MODULE_5__["Router"] },
                { type: _angular_router__WEBPACK_IMPORTED_MODULE_5__["ActivatedRoute"] },
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm2015/router.js");
            /* harmony import */ var src_app_services_patient_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! src/app/services/patient.service */ "./src/app/services/patient.service.ts");
            var PatientClinicListingComponent = /** @class */ (function () {
                function PatientClinicListingComponent(patientService, router, activatedRoute) {
                    var _this = this;
                    this.patientService = patientService;
                    this.router = router;
                    this.activatedRoute = activatedRoute;
                ...
                PatientClinicListingComponent.prototype.ngOnInit = function () {
                };
                PatientClinicListingComponent.prototype.getClinics = function () {
                    var _this = this;
                    this.patientService.getClinics().subscribe(function (data) {
                        _this.clinics = data;
                        _this.clinics.sort(function (a, b) { return (a.id > b.id) ? 1 : -1; });
                    });
                };
                PatientClinicListingComponent.prototype.showClinicInfo = function (clinic) {
                    this.router.navigate(['../showClinicInfo'], { relativeTo: this.activatedRoute, state: { data: clinic } });
                };
                PatientClinicListingComponent.prototype.sortName = function () {
                    this.sortingOption = "name";
                    this.sortClinics();
                };
                PatientClinicListingComponent.prototype.sortAddress = function () {
                    this.sortingOption = "address";
                    this.sortClinics();
                };
                PatientClinicListingComponent.prototype.sortCity = function () {
                    this.sortingOption = "city";
                    this.sortClinics();
                };
                PatientClinicListingComponent.prototype.sortState = function () {
                    this.sortingOption = "state";
                    this.sortClinics();
                };
                PatientClinicListingComponent.prototype.sortClinics = function () {
                    switch (this.sortingOption) {
                        case "name": {
                            this.clinics.sort(function (a, b) { return (a.name > b.name) ? 1 : -1; });
                            break;
                        }
                        case "address": {
                            this.clinics.sort(function (a, b) { return (a.address > b.address) ? 1 : -1; });
                            break;
                        }
                        case "city": {
                            this.clinics.sort(function (a, b) { return (a.city > b.city) ? 1 : -1; });
                            break;
                        }
                        case "state": {
                            this.clinics.sort(function (a, b) { return (a.state > b.state) ? 1 : -1; });
                            break;
                        }
                        default: {
                            this.clinics.sort(function (a, b) { return (a.id > b.id) ? 1 : -1; });
                            break;
                        }
                    }
                };
                PatientClinicListingComponent.prototype.ngOnDestroy = function () {
                    if (this.navigationSubscription) {
                        this.navigationSubscription.unsubscribe();
                    }
                };
            ...
            PatientClinicListingComponent.ctorParameters = function () { return [
                { type: src_app_services_patient_service__WEBPACK_IMPORTED_MODULE_3__["PatientService"] },
                { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] },
                { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"] }
            ]; };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
            /* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
            var PatientHomeComponent = /** @class */ (function () {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm2015/router.js");
            var PatientPendingAppointmentsListingComponent = /** @class */ (function () {
                function PatientPendingAppointmentsListingComponent(patientService, router, activatedRoute) {
                    ...
                    this.navigationSubscription = this.router.events.subscribe(function (e) {
                        if (e instanceof _angular_router__WEBPACK_IMPORTED_MODULE_3__["NavigationEnd"]) {
                            _this.getPendingAppointments();
                        }
                    });
                }
                PatientPendingAppointmentsListingComponent.prototype.ngOnInit = function () {
                };
                PatientPendingAppointmentsListingComponent.prototype.getPendingAppointments = function () {
                    var _this = this;
                ...
                PatientPendingAppointmentsListingComponent.prototype.sortClinicName = function () {
                    this.sortingOption = "clinicName";
                    this.sortPendingAppointments();
                };
                PatientPendingAppointmentsListingComponent.prototype.sortType = function () {
                    this.sortingOption = "type";
                    this.sortPendingAppointments();
                };
                PatientPendingAppointmentsListingComponent.prototype.sortDuration = function () {
                    this.sortingOption = "duration";
                    this.sortPendingAppointments();
                };
                PatientPendingAppointmentsListingComponent.prototype.sortDate = function () {
                    this.sortingOption = "date";
                    this.sortPendingAppointments();
                };
                PatientPendingAppointmentsListingComponent.prototype.sortPendingAppointments = function () {
                    switch (this.sortingOption) {
                        case "clinicName": {
                            this.appointments.sort(function (a, b) { return (a.clinic.name > b.clinic.name) ? 1 : -1; });
                            break;
                        }
                        case "type": {
                            this.appointments.sort(function (a, b) { return (a.typeOfExamination.name > b.typeOfExamination.name) ? 1 : -1; });
                            break;
                        }
                        case "duration": {
                            this.appointments.sort(function (a, b) { return (a.duration > b.duration) ? 1 : -1; });
                            break;
                        }
                        case "date": {
                            this.appointments.sort(function (a, b) { return (a.startingDateAndTime > b.startingDateAndTime) ? 1 : -1; });
                            break;
                        }
                        default: {
                            this.appointments.sort(function (a, b) { return (a.id > b.id) ? 1 : -1; });
                            break;
                        }
                    }
                };
                PatientPendingAppointmentsListingComponent.prototype.timeConverter = function (UNIX_timestamp) {
                    var a = new Date(UNIX_timestamp * 1000);
                    var months = ['Jan', 'Feb', 'Mar', 'Apr', 'May', 'Jun', 'Jul', 'Aug', 'Sep', 'Oct', 'Nov', 'Dec'];
                    var year = a.getFullYear();
                    var month = months[a.getMonth()];
                ...
                PatientPendingAppointmentsListingComponent.prototype.ngOnDestroy = function () {
                    if (this.navigationSubscription) {
                        this.navigationSubscription.unsubscribe();
                    }
                };
                PatientPendingAppointmentsListingComponent.prototype.showClinicInfo = function (info) {
                    //to do
                };
                return PatientPendingAppointmentsListingComponent;
            }());
            PatientPendingAppointmentsListingComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var MedicalRecordComponent = /** @class */ (function () {
                function MedicalRecordComponent(patientService, router, activatedRoute, userService) {
                    this.patientService = patientService;
                    this.router = router;
                    this.activatedRoute = activatedRoute;
                    this.userService = userService;
                ...
                MedicalRecordComponent.prototype.getMedicalRecord = function () {
                    var _this = this;
                ...
                MedicalRecordComponent.prototype.timeConverter = function (a) {
                    a = new Date(a * 1000);
                    var months = ['Jan', 'Feb', 'Mar', 'Apr', 'May', 'Jun', 'Jul', 'Aug', 'Sep', 'Oct', 'Nov', 'Dec'];
                    var year = a.getFullYear();
                    var month = months[a.getMonth()];
            ...
            MedicalRecordComponent.ctorParameters = function () { return [
                { type: src_app_services_patient_service__WEBPACK_IMPORTED_MODULE_2__["PatientService"] },
                { type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"] },
                { type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["ActivatedRoute"] },
                { type: src_app_services_user_service__WEBPACK_IMPORTED_MODULE_4__["UserService"] }
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var src_app_services_patient_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! src/app/services/patient.service */ "./src/app/services/patient.service.ts");
            /* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm2015/router.js");
            var PatientPersonalProfileComponent = /** @class */ (function () {
                function PatientPersonalProfileComponent(patientService, formBuilder, router) {
                    this.patientService = patientService;
                    this.formBuilder = formBuilder;
                    this.router = router;
                }
                PatientPersonalProfileComponent.prototype.ngOnInit = function () {
                    this.getPatientInfo();
                };
                PatientPersonalProfileComponent.prototype.getPatientInfo = function () {
                    var _this = this;
                    this.patientService.getPatient().subscribe(function (data) {
                        _this.patient = data;
                        _this.form = _this.formBuilder.group({
                            name: [_this.patient.name, [_angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required,]],
                            surname: [_this.patient.surname, [_angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required]],
                            email: [_this.patient.email, [_angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required, _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].email]],
                            address: [_this.patient.address, [_angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required]],
                            city: [_this.patient.city, [_angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required]],
                            state: [_this.patient.state, [_angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required]],
                            phoneNumber: [_this.patient.phoneNumber, [_angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required]],
                            upin: [_this.patient.upin, [_angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required, _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].minLength(13), _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].maxLength(13)]]
                        });
                        _this.change = true;
                    }, function (error) {
                        alert(error);
                ...
                PatientPersonalProfileComponent.prototype.enableChangeInfo = function () {
                    this.change = !this.change;
                };
                PatientPersonalProfileComponent.prototype.cancelChanges = function () {
                    this.change = !this.change;
                    this.getPatientInfo();
                };
                PatientPersonalProfileComponent.prototype.showChangePasswordForm = function () {
                    this.router.navigate(['../change-password']);
                };
                PatientPersonalProfileComponent.prototype.onSubmit = function () {
                    var _this = this;
                    this.submitted = true;
                    if (this.form.invalid) {
                        return;
                    ...
                    this.patientService.changePatient(patient).subscribe(function (data) { _this.change = !_this.change; return; }, function (error) { alert(error); });
                };
                return PatientPersonalProfileComponent;
            }());
            PatientPersonalProfileComponent.ctorParameters = function () { return [
                { type: src_app_services_patient_service__WEBPACK_IMPORTED_MODULE_3__["PatientService"] },
                { type: _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"] },
                { type: _angular_router__WEBPACK_IMPORTED_MODULE_4__["Router"] }
            ]; };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
            /* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
            var ChangePasswordDeactivateService = /** @class */ (function () {
                function ChangePasswordDeactivateService() {
                }
                ChangePasswordDeactivateService.prototype.canDeactivate = function (component, route, state, nextState) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var AppointmentService = /** @class */ (function () {
                ...
                AppointmentService.prototype.startAppointment = function (appointment) {
                ...
                AppointmentService.prototype.createAvailableAppointment = function (appointment) {
                    var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpHeaders"]({
                        'Authorization': "Bearer " + this.userService.getToken()
                    });
                ...
                AppointmentService.prototype.getClinicAvailableAppointments = function (clinic_id) {
                    var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpHeaders"]({
                        'Authorization': "Bearer " + this.userService.getToken()
                    });
                ...
                AppointmentService.prototype.deleteAvailableAppointment = function (appointment_id) {
                    var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpHeaders"]({
                        'Authorization': "Bearer " + this.userService.getToken()
                    });
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ClinicAdminService = /** @class */ (function () {
                ...
                ClinicAdminService.prototype.getAdminC = function () {
                    var user = JSON.parse(this.cookieService.get('user'));
                    var id = user["id"];
                ...
                ClinicAdminService.prototype.changeAdminC = function (adminC) {
                    var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpHeaders"]({
                ...
                ClinicAdminService.prototype.getClinic = function (clinicID) {
                    var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpHeaders"]({
                        'Authorization': "Bearer " + this.userService.getToken()
                    });
                ...
                ClinicAdminService.prototype.getVacationRequests = function () {
                ...
                ClinicAdminService.prototype.approveVacationRequest = function (request) {
                    var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpHeaders"]({
                        'Content-Type': 'application/json',
                        'Authorization': "Bearer " + this.userService.getToken()
                    });
                ...
                ClinicAdminService.prototype.rejectVacationRequest = function (request, message) {
                    var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpHeaders"]({
                        'Authorization': "Bearer " + this.userService.getToken()
                    });
            ...
            ClinicAdminService.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ClinicCenterAdminService = /** @class */ (function () {
                ...
                ClinicCenterAdminService.prototype.getAdminKc = function () {
                    var user = JSON.parse(this.cookieService.get('user'));
                    var id = user["id"];
                ...
                ClinicCenterAdminService.prototype.changeAdminKc = function (admin) {
                    var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({
                        'Content-Type': 'application/json',
                        'Authorization': "Bearer " + this.userService.getToken()
                    });
                ...
                ClinicCenterAdminService.prototype.deleteClinicAdmin = function (admin) {
                    var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({
                        'Authorization': "Bearer " + this.userService.getToken()
                    });
                ...
                ClinicCenterAdminService.prototype.getRegistrationRequests = function () {
                    var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({
                        'Authorization': "Bearer " + this.userService.getToken()
                    });
                ...
                ClinicCenterAdminService.prototype.approveRequest = function (request) {
                    var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({
                        'Content-Type': 'application/json',
                        'Authorization': "Bearer " + this.userService.getToken()
                    });
                ...
                ClinicCenterAdminService.prototype.deleteRequest = function (request, message) {
                    var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({
                        'Authorization': "Bearer " + this.userService.getToken()
                    });
            ...
            ClinicCenterAdminService.ctorParameters = function () { return [
                { type: ngx_cookie_service__WEBPACK_IMPORTED_MODULE_4__["CookieService"] },
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ClinicService = /** @class */ (function () {
                ...
                ClinicService.prototype.addOrdination = function (ordination, clinic_id) {
                    var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({
                        'Content-Type': 'application/json',
                        'Authorization': "Bearer " + this.userService.getToken()
                    });
                    return this.http.post("/api/ordinations/" + clinic_id, ordination, { headers: headers, observe: 'response' }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["map"])(function (response) {
                        return response.body;
                    }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["catchError"])(function (response) {
                        return Object(rxjs__WEBPACK_IMPORTED_MODULE_6__["throwError"])(response.error);
                    }));
                };
                ClinicService.prototype.editOrdination = function (ordination) {
                    var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({
                        'Content-Type': 'application/json',
                        'Authorization': "Bearer " + this.userService.getToken()
                    });
                    return this.http.put("/api/ordinations/change", ordination, { headers: headers, observe: 'response' }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["map"])(function (response) {
                        return response.body;
                    }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["catchError"])(function (response) {
                        return Object(rxjs__WEBPACK_IMPORTED_MODULE_6__["throwError"])(response.error);
                    }));
                };
                ClinicService.prototype.deleteOrdination = function (id) {
                    var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({
                        'Content-Type': 'application/json',
                        'Authorization': "Bearer " + this.userService.getToken()
                    });
                    return this.http.delete("/api/ordinations/delete/" + id, { headers: headers, observe: 'response' }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["map"])(function (response) {
                        return response.body;
                    }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["catchError"])(function (response) {
                        return Object(rxjs__WEBPACK_IMPORTED_MODULE_6__["throwError"])(response.error);
                    }));
                };
                ClinicService.prototype.approvePrescription = function (prescription) {
                    var user = JSON.parse(this.cookieService.get('user'));
                    var id = user["id"];
                    var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({
                        'Content-Type': 'application/json',
                    ...
                    return this.http.put("/api/prescriptions/approve/" + id, JSON.stringify(prescription), { headers: headers, observe: 'response' }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["map"])(function (response) {
                        return response.body;
                    }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["catchError"])(function (response) {
                        return Object(rxjs__WEBPACK_IMPORTED_MODULE_6__["throwError"])(response.error);
                    }));
                };
                ClinicService.prototype.getOrdinations = function (clinicID) {
                    var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({
                        'Content-Type': 'application/json',
                        'Authorization': "Bearer " + this.userService.getToken()
                    });
                ...
                ClinicService.prototype.getPrescriptions = function (clinicID) {
                    var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({
                        'Content-Type': 'application/json',
                        'Authorization': "Bearer " + this.userService.getToken()
                    });
                ...
                ClinicService.prototype.searchOrdinations = function (ordination) {
                    var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({
                        'Content-Type': 'application/json',
                        'Authorization': "Bearer " + this.userService.getToken()
                    });
                ...
                ClinicService.prototype.searchPrescriptions = function (prescription) {
                    var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({
                        'Content-Type': 'application/json',
                        'Authorization': "Bearer " + this.userService.getToken()
                    });
                ...
                ClinicService.prototype.addClinic = function (clinic) {
                    var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({
                        'Content-Type': 'application/json',
                        'Authorization': "Bearer " + this.userService.getToken()
                    });
                ...
                ClinicService.prototype.getClinics = function () {
                    var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({
                        'Authorization': "Bearer " + this.userService.getToken()
                    });
                ...
                ClinicService.prototype.getClinic = function (id) {
                    var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({
                        'Content-Type': 'application/json',
                        'Authorization': "Bearer " + this.userService.getToken()
                    });
                ...
                ClinicService.prototype.changeClinicInfo = function (changedClinic) {
                    var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({
                        'Content-Type': 'application/json',
                        'Authorization': "Bearer " + this.userService.getToken()
                    });
                ...
                ClinicService.prototype.getClinicAdmins = function (id) {
                    var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({
                        'Authorization': "Bearer " + this.userService.getToken()
                    });
                ...
                ClinicService.prototype.addDoctor = function (doctor) {
                    var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({
                        'Content-Type': 'application/json',
                        'Authorization': "Bearer " + this.userService.getToken()
                    });
                    return this.http.post('/api/doctor', JSON.stringify(doctor), { headers: headers, observe: 'response' }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["map"])(function (response) {
                        return response.body;
                    }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["catchError"])(function (response) {
                        return Object(rxjs__WEBPACK_IMPORTED_MODULE_6__["throwError"])(response.error);
                    }));
                };
                ClinicService.prototype.addNurse = function (nurse) {
                    var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({
                        'Content-Type': 'application/json',
                        'Authorization': "Bearer " + this.userService.getToken()
                    });
                    return this.http.post('/api/nurse', JSON.stringify(nurse), { headers: headers, observe: 'response' }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["map"])(function (response) {
                        return response.body;
                    }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["catchError"])(function (response) {
                        return Object(rxjs__WEBPACK_IMPORTED_MODULE_6__["throwError"])(response.error);
                    }));
                };
                ClinicService.prototype.deleteNurse = function (id) {
                    var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({
                        'Content-Type': 'application/json',
                        'Authorization': "Bearer " + this.userService.getToken()
                    });
                    return this.http.delete("/api/nurse/delete/" + id, { headers: headers, observe: 'response' }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["map"])(function (response) {
                        return response.body;
                    }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["catchError"])(function (response) {
                        return Object(rxjs__WEBPACK_IMPORTED_MODULE_6__["throwError"])(response.error);
                    }));
                };
                ClinicService.prototype.deleteDoctor = function (id) {
                    var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({
                        'Content-Type': 'application/json',
                        'Authorization': "Bearer " + this.userService.getToken()
                    });
                    return this.http.delete("/api/doctor/delete/" + id, { headers: headers, observe: 'response' }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["map"])(function (response) {
                        return response.body;
                    }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["catchError"])(function (response) {
                        return Object(rxjs__WEBPACK_IMPORTED_MODULE_6__["throwError"])(response.error);
                    }));
                };
                ClinicService.prototype.addAdmin = function (admin) {
                    var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({
                        'Content-Type': 'application/json',
                        'Authorization': "Bearer " + this.userService.getToken()
                    });
                    return this.http.post('/api/clinicAdmin/add', JSON.stringify(admin), { headers: headers, observe: 'response' }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["map"])(function (response) {
                        return response.body;
                    }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["catchError"])(function (response) {
                        return Object(rxjs__WEBPACK_IMPORTED_MODULE_6__["throwError"])(response.error);
                    }));
                };
                ClinicService.prototype.deleteClinic = function (clinic) {
                    var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({
                        'Content-Type': 'application/json',
                        'Authorization': "Bearer " + this.userService.getToken()
                    });
                    return this.http.delete("/api/admin/deleteClinic/" + clinic.id, { headers: headers, observe: 'response' }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["map"])(function (response) {
                        return response.body;
                    }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["catchError"])(function (response) {
                        return Object(rxjs__WEBPACK_IMPORTED_MODULE_6__["throwError"])(response.error);
                    }));
                };
                ClinicService.prototype.getDoctors = function (clinic_id) {
                    var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({
                        'Content-Type': 'application/json',
                        'Authorization': "Bearer " + this.userService.getToken()
                    });
                ...
                ClinicService.prototype.getNurses = function (clinic_id) {
                    var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({
                        'Content-Type': 'application/json',
                        'Authorization': "Bearer " + this.userService.getToken()
                    });
                ...
                ClinicService.prototype.searchDoctors = function (doctor) {
                    var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({
                        'Content-Type': 'application/json',
                        'Authorization': "Bearer " + this.userService.getToken()
                    });
                ...
                ClinicService.prototype.searchNurses = function (nurse) {
                    var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({
                        'Content-Type': 'application/json',
                        'Authorization': "Bearer " + this.userService.getToken()
                    });
                ...
                ClinicService.prototype.getTypesOfExamination = function (clinic_id) {
                    var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({
                        'Content-Type': 'application/json',
                        'Authorization': "Bearer " + this.userService.getToken()
                    });
                ...
                ClinicService.prototype.searchTypesOfExamination = function (type) {
                    var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({
                        'Content-Type': 'application/json',
                        'Authorization': "Bearer " + this.userService.getToken()
                    });
                ...
                ClinicService.prototype.deleteTypeOfExamination = function (typeOfExamination_id) {
                    var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({
                        'Content-Type': 'application/json',
                        'Authorization': "Bearer " + this.userService.getToken()
                    });
                    return this.http.delete("/api/examinationTypes/delete/" + typeOfExamination_id, { headers: headers, observe: 'response' }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["map"])(function (response) {
                        return response.body;
                    }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["catchError"])(function (response) {
                        return Object(rxjs__WEBPACK_IMPORTED_MODULE_6__["throwError"])(response.error);
                    }));
                };
                ClinicService.prototype.editTypeOfExamination = function (typeOfExamination) {
                    var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({
                        'Content-Type': 'application/json',
                        'Authorization': "Bearer " + this.userService.getToken()
                    });
                    return this.http.put("/api/examinationTypes/change", typeOfExamination, { headers: headers, observe: 'response' }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["map"])(function (response) {
                        return response.body;
                    }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["catchError"])(function (response) {
                        return Object(rxjs__WEBPACK_IMPORTED_MODULE_6__["throwError"])(response.error);
                    }));
                };
                ClinicService.prototype.addTypeOfExamination = function (typeOfExamination, clinic_id) {
                    var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({
                        'Content-Type': 'application/json',
                        'Authorization': "Bearer " + this.userService.getToken()
                    });
                    return this.http.post("/api/examinationTypes/" + clinic_id, typeOfExamination, { headers: headers, observe: 'response' }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["map"])(function (response) {
                        return response.body;
                    }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["catchError"])(function (response) {
                        return Object(rxjs__WEBPACK_IMPORTED_MODULE_6__["throwError"])(response.error);
                    }));
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var rxjs__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! rxjs */ "./node_modules/rxjs/_esm2015/index.js");
            /* harmony import */ var _user_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./user.service */ "./src/app/services/user.service.ts");
            var ClinicalCenterService = /** @class */ (function () {
                ...
                ClinicalCenterService.prototype.getMedications = function () {
                    var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({
                        'Authorization': "Bearer " + this.userService.getToken()
                    });
                ...
                ClinicalCenterService.prototype.addMedication = function (medication) {
                    var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({
                        'Content-Type': 'application/json',
                        'Authorization': "Bearer " + this.userService.getToken()
                    });
                ...
                ClinicalCenterService.prototype.editMedication = function (changedMedication) {
                    var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({
                        'Content-Type': 'application/json',
                        'Authorization': "Bearer " + this.userService.getToken()
                    });
                ...
                ClinicalCenterService.prototype.deleteMedication = function (id) {
                    var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({
                        'Authorization': "Bearer " + this.userService.getToken()
                    });
                ...
                ClinicalCenterService.prototype.getDiagnosis = function () {
                    var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({
                        'Authorization': "Bearer " + this.userService.getToken()
                    });
                ...
                ClinicalCenterService.prototype.addDiagnosis = function (diagnosis) {
                    var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({
                        'Content-Type': 'application/json',
                        'Authorization': "Bearer " + this.userService.getToken()
                    });
                ...
                ClinicalCenterService.prototype.editDiagnosis = function (changedDiagnosis) {
                    var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({
                        'Content-Type': 'application/json',
                        'Authorization': "Bearer " + this.userService.getToken()
                    });
                ...
                ClinicalCenterService.prototype.deleteDiagnosis = function (id) {
                    var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({
                        'Authorization': "Bearer " + this.userService.getToken()
                    });
            ...
            ClinicalCenterService.ctorParameters = function () { return [
                { type: ngx_cookie_service__WEBPACK_IMPORTED_MODULE_4__["CookieService"] },
                { type: _user_service__WEBPACK_IMPORTED_MODULE_7__["UserService"] },
                { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] },
                { type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"] }
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var DialogService = /** @class */ (function () {
                ...
                DialogService.prototype.confirm = function (title, message, userInput, btnOkText, btnCancelText, dialogSize) {
                    if (btnOkText === void 0) { btnOkText = 'OK'; }
                    if (btnCancelText === void 0) { btnCancelText = 'Cancel'; }
                    if (dialogSize === void 0) { dialogSize = 'lg'; }
                    var modalRef = this.modalService.open(_components_helperComponents_dialog_dialog_component__WEBPACK_IMPORTED_MODULE_3__["DialogComponent"], { size: dialogSize });
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var DoctorService = /** @class */ (function () {
                ...
                DoctorService.prototype.getAppointments = function () {
                    var user = JSON.parse(this.cookieService.get('user'));
                    var id = user["id"];
                    var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpHeaders"]({
                ...
                DoctorService.prototype.getOneAppointment = function (appID) {
                    var user = JSON.parse(this.cookieService.get('user'));
                    var id = user["id"];
                    var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpHeaders"]({
                        'Accept': 'application/json',
                ...
                DoctorService.prototype.getVacations = function () {
                    var user = JSON.parse(this.cookieService.get('user'));
                    var id = user["id"];
                    var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpHeaders"]({
                        'Accept': 'application/json',
                ...
                DoctorService.prototype.changeDoctor = function (doctor) {
                    var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpHeaders"]({
                        'Content-Type': 'application/json',
                        'Authorization': "Bearer " + this.userService.getToken()
                    });
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var NurseService = /** @class */ (function () {
                ...
                NurseService.prototype.changeNurse = function (nurse) {
                    var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpHeaders"]({
                        'Content-Type': 'application/json',
                        'Authorization': "Bearer " + this.userService.getToken()
                    });
                ...
                NurseService.prototype.getVacations = function () {
                    var user = JSON.parse(this.cookieService.get('user'));
                    var id = user["id"];
                    var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpHeaders"]({
                        'Accept': 'application/json',
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var PatientService = /** @class */ (function () {
                ...
                PatientService.prototype.getPatientById = function (patient_id) {
                    var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpHeaders"]({
                        'Authorization': "Bearer " + this.userService.getToken()
                    });
                ...
                PatientService.prototype.changePatient = function (patient) {
                    var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpHeaders"]({
                        'Content-Type': 'application/json',
                        'Authorization': "Bearer " + this.userService.getToken()
                    });
                ...
                PatientService.prototype.getClinic = function (clinic_id) {
                    var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpHeaders"]({
                        'Content-Type': 'application/json',
                        'Authorization': "Bearer " + this.userService.getToken()
                    });
                ...
                PatientService.prototype.getPendingAppointments = function () {
                    var user = JSON.parse(this.cookieService.get('user'));
                    var id = user["id"];
                    var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpHeaders"]({
                        'Content-Type': 'application/json',
                ...
                PatientService.prototype.getClinicPatients = function () {
                    var user = JSON.parse(this.cookieService.get('user'));
                ...
                PatientService.prototype.getMedicalRecord = function (id) {
                    if (!id) {
                        var user = JSON.parse(this.cookieService.get('user'));
                        id = user.id;
                    }
                ...
                PatientService.prototype.searchPatients = function (patient) {
                    var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpHeaders"]({
                        'Content-Type': 'application/json',
                        'Authorization': "Bearer " + this.userService.getToken()
                    });
                ...
                PatientService.prototype.checkAuthorityToViewMedicalRecord = function (patient_id) {
                    var user = JSON.parse(this.cookieService.get('user'));
                    var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpHeaders"]({
                        'Content-Type': 'application/json',
                        'Authorization': "Bearer " + this.userService.getToken()
            ...
            var UserService = /** @class */ (function () {
                function UserService(cookieService, http, injector) {
                    ...
                    Object(rxjs__WEBPACK_IMPORTED_MODULE_6__["interval"])(200000)
                        .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["flatMap"])(function () { return _this.refreshToken(); })).subscribe(function () { });
                }
                Object.defineProperty(UserService.prototype, "router", {
                    get: function () { return this.injector.get(_angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"]); },
                    enumerable: true,
                    configurable: true
                });
                /*
                ...
                */
                ...
                UserService.prototype.tokenIsPresent = function () {
                ...
                */
                UserService.prototype.login = function (email, password) {
                    ...
                    return this.http.post('/auth/login', user, { headers: headers, observe: 'response' })
                        .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["map"])(function (response) {
                        var userState = response.body;
                        _this.setUser(userState['user']);
                        _this.setToken(userState['token']);
                        _this.passwordChanged = userState['passwordChanged'];
                        if (!_this.passwordChanged) {
                            _this.router.navigate(['/change-password']);
                        }
                        else {
                            if (_this.checkLoggedIn().roles.indexOf('PATIENT') != -1) {
                                _this.router.navigate(['/patient']);
                            }
                            else if (_this.checkLoggedIn().roles.indexOf('DOCTOR') != -1) {
                                _this.router.navigate(['/doctor']);
                            }
                            else if (_this.checkLoggedIn().roles.indexOf('NURSE') != -1) {
                                _this.router.navigate(['/nurse']);
                            }
                            else if (_this.checkLoggedIn().roles.indexOf('ADMINCC') != -1) {
                                _this.router.navigate(['/adminCC']);
                            }
                            else {
                                _this.router.navigate(['/']);
                            }
                ...
                UserService.prototype.register = function (registerRequest) {
                    var _this = this;
                    var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({
                        'Accept': 'application/json',
                        'Content-Type': 'application/json'
                    });
                    return this.http.post('/auth/signup', registerRequest, { headers: headers, observe: 'response' })
                        .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["map"])(function (response) {
                        var userState = response.body;
                ...
                UserService.prototype.changePassowrd = function (passwordChanger) {
                    var _this = this;
                    var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({
                        'Accept': 'application/json',
                        'Content-Type': 'application/json',
                    ...
                    return this.http.post('/auth/change-password', JSON.stringify(passwordChanger), { headers: headers, observe: 'response' })
                        .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["map"])(function (response) {
                ...
                UserService.prototype.refreshToken = function () {
                    ...
                    if (!(this.cookieService.get('token') === '')) {
                        ...
                        return this.http.post('/auth/refresh', {}, { headers: headers, observe: 'response' })
                            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["map"])(function (response) {
                            var userState = response.body;
                            _this.setUser(userState['user']);
                            _this.setToken(userState['token']);
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var VacationService = /** @class */ (function () {
                ...
                VacationService.prototype.sendRequest = function (vacation) {
                    var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpHeaders"]({
                        'Authorization': "Bearer " + this.userService.getToken()
                    });
